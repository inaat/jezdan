...
class SystemSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.admin.global_configuration.global_configuration')->with(compact('theme_colors','mail_drivers','email_settings','common_settings','sms_settings','timezone_list', 'date_formats', 'month_list', 'currencies', 'general_settings'));
    }
