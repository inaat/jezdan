...
class MobileSliderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.notification.mobile-slider.index');
    }
    ...
    {
        return view('tenant.notification.mobile-slider.create');
    ...
    public function edit($id)
    {
        ...
        return view('tenant.notification.mobile-slider.edit')->with(compact('slider'));
