...
//            dd('ok');
        ...
        return view('tenant.fee_allocation.index')->with(compact('campuses', 'sessions'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.fee_allocation.create')->with(compact('campuses', 'now_month', 'sessions', 'active_session'));
    }
    public function feesAssignSearch(Request $request)
    {
        ...
        return view('tenant.fee_allocation.fees_assign')->with(compact('students', 'fee_heads', 'campuses', 'classes', 'sections', 'campus_id', 'class_id', 'class_section_id', 'month_year', 'due_date'));
    }
    ...
    public function bulkAllocationCreate()
    {
        ...
        return view('tenant.fee_allocation.bulk-fee-create')->with(compact('campuses', 'now_month', 'sessions', 'active_session'));
    }
