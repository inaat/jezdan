...
class ExamMarkController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.Examination.exam_mark.create_mark_print')->with(compact('campuses','sessions','grades'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.Examination.exam_mark.create')->with(compact('campuses','sessions','grades'));
    }
    //   /**
    ...
    public function store(Request $request)
    {
        ...
        ,'campuses','session','current_class','current_class_section','exam_create','exam_create.term','subject_name','teacher'])
           ...
           //dd($json_grades[0]['id']);
           return view('tenant.Examination.exam_mark.mark_entry')->with(compact('campuses','sessions','classes','sections','grades','json_grades','terms','campus_id','class_id','exam_create_id','class_section_id','session_id','subject_id','classSubject','subs'));
...
if ($user->user_type == 'teacher') {
    ...
    private function receiptContent($subs)
    {
        ...
        $receipt_details=[];
        $output['html_content'] = view('tenant.Examination.exam_mark.mark_print', compact('subs'))->render();
