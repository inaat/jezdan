...
class ExamDateSheetController extends Controller
{
    ...
    //    dd($date_sheets);
        ...
        return view('tenant.Examination.exam_date_sheet.index')->with(compact('campuses', 'sessions'));
    }
    /**
    ...
    public function create()
    {
        ...
        return view('tenant.Examination.exam_date_sheet.create')->with(compact('campuses', 'sessions'));
    }
    //   /**
    ...
    public function edit($id)
    {
        ...
        return view('tenant.Examination.exam_date_sheet.edit')->with(compact('campuses', 'classes', 'class_sections', 'classSubject', 'terms', 'sessions', 'date_sheet'));
    }
    /**
    ...
    public function createClassWiseRollSlipPrint()
    {
        ...
        return view('tenant.Examination.exam_date_sheet.date_sheet')->with(compact('campuses', 'sessions'));
    }
    ...
    private function receiptContent($data, $details)
    {
        ...
        $output['html_content'] = view('tenant.Examination.exam_date_sheet.roll_no_slip', compact('data', 'details'))->render();
    ...
    private function lableReceiptContent($total_qty, $product_details)
    {
        ...
        $output['html_content'] = view('tenant.Examination.exam_date_sheet.lable', compact('product_details', 'barcode_details', 'page_height'))->render();
    ...
    public function bulkCreate()
    {
        ...
        return view('tenant.Examination.exam_date_sheet.bulk_create')->with(compact('campuses', 'sessions'));
    }
    public function getSubjectDateSheet(Request $request)
    {
       ...
       // $class_section_id = $input['class_section_id'];
        ...
        return view('tenant.Examination.exam_date_sheet.get_subjects')->with(
            compact(
                'campuses',
                'sessions',
                'subjects',
...
/**
    ...
    private function SingleReceiptContent($classes,$details)
    {
        ...
        $output['html_content'] = view('tenant.Examination.exam_date_sheet.date_sheet_print', compact('details','classes'))->render();
