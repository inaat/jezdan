...
class ExamSetupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.Examination.exam_setup.index');
    }
    ...
    public function create()
    {
        ...
        return view('tenant.Examination.exam_setup.create', compact('class_sections', 'exam_terms', 'campuses'));
    }
  ...
  /**
    ...
    public function edit($id)
    {
        ...
        return view('tenant.Examination.exam_setup.edit', compact('exam_create', 'students'));
    }
    ...
    public function updateSubjectsMark($id)
    {
        ...
        return view('tenant.Examination.exam_setup.update_subjects_marks', compact('exam_create', 'class_wise_subjects'));
    }
public function updateSubjectsMarkPost(Request $request)
{
    ...
    public function enrolledStudents($id)
    {
        ...
        return view('tenant.Examination.exam_setup.enrolled_students', compact('students'));
    }
...
public function missingSubjects($id)
{
    ...
    return view('tenant.Examination.exam_setup.missing_subjects', compact('missing_subjects', 'exam_create'));
}
...
public function enrolledSubjects($id)
{
    ...
    return view('tenant.Examination.exam_setup.enrolled_subjects', compact('missing_subjects', 'exam_create'));
}
