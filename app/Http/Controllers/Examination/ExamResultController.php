...
class ExamResultController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.Examination.exam_result.index')->with(compact('campuses', 'sessions'));
    }
    public function store(Request $request)
    {
        ...
        return view('tenant.Examination.exam_result.list')->with(compact('students', 'campuses', 'sessions', 'classes', 'sections', 'terms', 'campus_id', 'class_id', 'exam_create_id', 'class_section_id', 'session_id'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.Examination.exam_result.create')->with(compact('campuses', 'sessions'));
    }
    /**
     * Show the form for editing the specified resource.
     * @param int $id
    ...
    private function receiptContent($details)
    {
        ...
        $output['html_content'] = view('tenant.Examination.exam_result.show', compact('details'))->render();
    ...
    private function bulkReceiptContent($students_details)
    {
        ...
        $output['html_content'] = view('tenant.Examination.exam_result.mark_sheet', compact('students_details'))->render();
    ...
    public function topPositionsCreate()
    {
        ...
        return view('tenant.Examination.top-position.create')->with(compact('campuses', 'sessions', 'class_level'));
    }
    public function topPositionsPost(Request $request)
    {
        ...
        // return view('tenant.Examination.top-position.show')->with(compact('students'));
    }
    ...
    private function topReceiptContent($students, $class_level_name,$limit)
    {
        ...
        $output['html_content'] = view('tenant.Examination.top-position.show')->with(compact('students', 'class_level_name','limit'))->render();
    ...
    public function topPositionListCreate()
    {
        ...
        return view('tenant.Examination.exam_result.top_position_list_create')->with(compact('campuses', 'sessions'));
    }
