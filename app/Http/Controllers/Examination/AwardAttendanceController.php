...
class AwardAttendanceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.Examination.award-attendance.index')->with(compact('campuses','sessions'));
    }
    ...
    private function receiptContent($data)
    {
        ...
        $output['html_content'] = view('tenant.Examination.award-attendance.awardlist', compact('data'))->render();
