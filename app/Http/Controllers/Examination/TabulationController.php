...
class TabulationController extends Controller
{
    public function index()
    {
        ...
        return view('tenant.Examination.tabulation_sheet.index')->with(compact('campuses', 'sessions'));
    }
    ...
    ->where('exam_create_id', $input['exam_create_id'])->orderBy('class_section_position', 'ASC')->get();
        ...
        return view('tenant.Examination.tabulation_sheet.tabulation_sheet')->with(compact('campuses', 'sessions', 'get_subjects', 'students', 'classes', 'sections', 'terms', 'campus_id', 'class_id', 'exam_create_id', 'class_section_id', 'session_id'));
    }
    public function create()
    {
        ...
        return view('tenant.Examination.tabulation_sheet.create')->with(compact('campuses', 'sessions'));
    }
    ...
    private function bulkReceiptContent($details)
    {
        ...
        $output['html_content'] = view('tenant.Examination.tabulation_sheet.tabulation-sheet-print', compact('details'))->render();
