...
class PromotionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.Examination.promotion.index')->with(compact('campuses', 'sessions'));
    }
    public function withoutGetStudentList(Request $request)
    {
        ...
        return view('tenant.Examination.promotion.without_get_student_list')->with(compact('campuses', 'sessions', 'classes', 'sections', 'campus_id', 'class_id', 'class_section_id', 'students'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.Examination.promotion.create')->with(compact('campuses', 'sessions'));
    }
    ...
    public function getStudentList(Request $request)
    {
        ...
        return view('tenant.Examination.promotion.student_list')->with(compact('campuses', 'sessions', 'classes', 'sections', 'terms', 'campus_id', 'class_id', 'exam_create_id', 'class_section_id', 'session_id', 'students'));
    }
...
if (!auth()->user()->can('promotion.with_exam')) {
    ...
    public function passOutCreate()
    {
        ...
        return view('tenant.Examination.promotion.pass_out_create')->with(compact('campuses', 'sessions'));
    }
    public function passOutPost(Request $request)
    {
        ...
        return view('tenant.Examination.promotion.pass_out_get_student_list')->with(compact('campuses', 'sessions', 'classes', 'sections', 'campus_id', 'class_id', 'class_section_id', 'students'));
    }
