...
class RoutineTestController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.Examination.routine_test.create_mark_print')->with(compact('campuses','sessions','grades'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.Examination.routine_test.create')->with(compact('campuses','sessions','grades'));
    }
    //   /**
    ...
    public function store(Request $request)
    {
        ...
        if (!auth()->user()->can('exam_mark_entry.create')) {
          ...
          //  dd($subs);
           ...
           //dd($json_grades[0]['id']);
           return view('tenant.Examination.routine_test.mark_entry')->with(compact('students','type','campuses','sessions','classes','sections','grades','json_grades','campus_id','class_id','date','class_section_id','session_id','subject_id','classSubject','subs'));
...
if ($user->user_type == 'teacher') {
    ...
    public function studentCreate()
    {
        ...
        return view('tenant.Examination.routine_test.single_print_create')->with(compact('campuses','sessions','grades'));
    }
    ...
    private function receiptContent1($subs)
    {
        ...
        $receipt_details=[];
        $output['html_content'] = view('tenant.Examination.routine_test.report_routine_test_print', compact('subs'))->render();
    ...
    private function receiptContent($subs)
    {
        ...
        $output['is_enabled'] = true;
        $receipt_details=[];
        $output['html_content'] = view('tenant.Examination.routine_test.mark_print', compact('subs'))->render();
