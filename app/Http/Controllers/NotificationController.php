...
class NotificationController extends Controller
{
    ...
    public function lessonProgressSendCreate()
    {
        ...
        return view('tenant.whatsapp.lesson_progress_create')->with(compact('campuses', 'sessions'));
    }
    ...
    {
        $campuses=Campus::forDropdown();
        return view('tenant.notification.fee_remainder.fee_remainder_create')->with(compact('campuses'));
    }
    ...
    {
        return view('tenant.notification.media-send');
