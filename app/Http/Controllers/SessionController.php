...
class SessionController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($sessions)
                ...
                ->editColumn(
                    'status',
                    function ($row) {
                        return (string) view('tenant.admin.global_configuration.session.session_status',['status'=>$row->status,'id' => $row->id]);
                    }
                )
        ...
        return view('tenant.admin.global_configuration.session.index');
    }
    ...
    public function create()
    {
        ...
        return view('tenant.admin.global_configuration.session.create');
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.admin.global_configuration.session.edit')
