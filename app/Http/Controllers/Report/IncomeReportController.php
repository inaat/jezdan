...
class IncomeReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.Report.income.index')->with(compact('campuses'));
    }
    public function store(Request $request)
    {
        ...
        if ($pdf) {
            ...
            $snappy = \WPDF::loadview('tenant.Report.income.income-report', compact('campus_id', 'student_payments', 'hrm_payments', 'expenses_payments'));
    ...
    public function FeePaidToday(Request $request)
    {
        ...
        if (request()->ajax()) {
            ...
            //dd($student_payments);
            return view('tenant.Report.income.fee_paid_today')->with(compact('student_payments'));
        }
    }
    public function TransportFeePaidToday(Request $request)
    {
        ...
        if (request()->ajax()) {
            ...
            $student_payments = $this->__payment($campus_id, $start, $end);
            //dd($student_payments);
            return view('tenant.Report.income.fee_transport_paid_today')->with(compact('student_payments'));
        }
    }
    ...
    public function IncomeSummaryCreate()
    {
        ...
        // }
        return view('tenant.Report.income.income_summary')->with(compact('campuses'));
