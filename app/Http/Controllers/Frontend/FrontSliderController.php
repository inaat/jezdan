...
class FrontSliderController extends Controller
{
  ...
  /**
    ...
    public function index()
    {
        ...
        return view('tenant.frontend.backend.slider.index');
    }
   ...
   {
       return view('tenant.frontend.backend.slider.create');
   }

   public function edit($id)
   {
       $slider= FrontSlider::find($id);
       return view('tenant.frontend.backend.slider.edit')->with(compact('slider'));
       ;
   }
