...
class FrontNoticeController extends Controller
{
     ...
     /**
       ...
       public function index()
       {
           ...
           return view('tenant.frontend.backend.notice.index');
       }
   ...
   public function show($slug, $id){
     ...
     // ->orWhere('slug', $slug)
      ...
      //dd();
    return view('tenant.frontend.notice.show')->with(compact('data','nav'));

   }
   public function create()
   {
       return view('tenant.frontend.backend.notice.create');
   }
   ...
   public function edit($id)
   {
       ...
       return view('tenant.frontend.backend.notice.edit')->with(compact('notice'));
   }
