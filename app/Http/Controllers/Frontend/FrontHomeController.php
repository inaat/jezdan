...
class FrontHomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.frontend.index')->with(compact('slider', 'news', 'about_us', 'topers','galleries','events'));
    }
    public function about_index()
    {
        $data = FrontAboutUs::first();
        $nav = frontMenu();
        return view('tenant.frontend.about_us.show')->with(compact('data', 'nav'));
    }
    ...
    public function event_index()
    {
        ...
        $nav = frontEventMenu();
        return view('tenant.frontend.event.show')->with(compact('data', 'nav'));
    }
    public function news_index()
    {
        $data = FrontNews::first();
        $nav = frontNewsMenu();
        return view('tenant.frontend.news.show')->with(compact('data', 'nav'));
    }
    ...
    public function show_page_index($slug, $id)
    {
        ...
        //dd();
        return view('tenant.frontend.custom_page.show')->with(compact('data', 'nav'));
    }
    ...
    public function gallery()
    {
        ...
        return view('tenant.frontend.gallery.index')->with(compact('albums'));
    }
    public function gallery_show($slug, $id)
    {
        $query=FrontGalleryContent::where('id', $id)->firstOrFail();
        $data=json_decode($query->elements);
        return view('tenant.frontend.gallery.show')->with(compact('query', 'data'));
    }
    public function examResult()
    {        return view('tenant.frontend.exam_result');
    }
    ...
    ->get();
      $faculty=[];
        ...
        return view('tenant.frontend.faculty')->with(compact('faculty'));
    }
...
public function onlineApply(){
    ...
    return view('tenant.frontend.online-apply')->with(compact('countries','campuses','sessions','districts'));
}
public function saveApply(Request $request){
    ...
    try {
        ...
        $online_applicants_data['online_applicant_no'] = $this->commonUtil->generateReferenceNumber($prefix_type, $ref_count, 1);
         ...
         return view('tenant.frontend.submit-success');
