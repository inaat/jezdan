...
class FrontCustomPageNavbarController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        return view('tenant.frontend.backend.page_navbar.index');
}
...
public function create()
{
    ...
    return view('tenant.frontend.backend.page_navbar.create');
}
...
public function edit($id)
{
    ...
    return view('tenant.frontend.backend.page_navbar.edit')->with(compact('navbar'));
