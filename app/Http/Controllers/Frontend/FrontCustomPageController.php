    ...
    */
    ...
    public function index()
    {
       // dd(FrontCustomPageNavbar::with('custom_pages')->get());
        ...
        return view('tenant.frontend.backend.custom_page.index');
}
...
public function create()
{
    ...
    return view('tenant.frontend.backend.custom_page.create')->with(compact('custom_navbars'));
}
...
public function edit($id)
{
    ...
    return view('tenant.frontend.backend.custom_page.edit')->with(compact('custom_page','custom_navbars'));
...
public function addImage($id)
{
    ...
    return view('tenant.frontend.backend.custom_page.add_image')->with(compact('gallery', 'getJson'));
    ;
}
public function element($id)
{
    $gallery= FrontCustomPage::find($id);
    $getJson = json_decode($gallery->elements, true);
    return view('tenant.frontend.backend.custom_page.element')->with(compact('gallery', 'getJson'));
    ;
}
