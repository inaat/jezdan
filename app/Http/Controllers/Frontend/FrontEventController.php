...
class FrontEventController extends Controller
{
  ...
  /**
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($sliders)
                            ...
                            ->editColumn('images', function ($row) {
                                    ...
                                    $img=' <img src="'.url('tenant/uploads/front_image/' . $images).'" class="img-border " width="50" height="50" alt="" ></div>';
                                    return $img;
                            })
                            ->removeColumn('id')
        ...
        return view('tenant.frontend.backend.event.index');
    }
   ...
   {
       return view('tenant.frontend.backend.event.create');
   }

   public function edit($id)
   {
       $event= FrontEvent::find($id);
       return view('tenant.frontend.backend.event.edit')->with(compact('event'));
