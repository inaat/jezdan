...
class FrontGalleryController extends Controller
{
  ...
  /**
    ...
    public function index()
    {
                            ...
                            ->addColumn(
                             ...
                             <ul class="dropdown-menu" style="">';
                                ...
                                ->editColumn('thumb_image', function ($row) {
                                    ...
                                    $img=' <img src="'.url('tenant/uploads/front_image/' . $image).'" class="img-border " width="50" height="50" alt="" ></div>';
                                    return $img;
                                })
        ...
        return view('tenant.frontend.backend.gallery.index');
    }
   ...
   public function SearchInGallery(Request $request)
   {
       ...
       try {
           ...
           //dd($albums);
           $output['html_content'] =  view('tenant.frontend.gallery.row-gallery')
           ->with(compact(
               'albums'
           ))
           ->render();
   ...
   {
       return view('tenant.frontend.backend.gallery.create');
   }
   ...
   public function edit($id)
   {
       ...
       return view('tenant.frontend.backend.gallery.edit')->with(compact('gallery'));
       ;
   }
   ...
   public function addImage($id)
   {
       ...
       return view('tenant.frontend.backend.gallery.add_image')->with(compact('gallery', 'getJson'));
       ;
   }
   public function element($id)
   {
       $gallery= FrontGalleryContent::find($id);
       $getJson = json_decode($gallery->elements, true);
       return view('tenant.frontend.backend.gallery.element')->with(compact('gallery', 'getJson'));
       ;
   }
