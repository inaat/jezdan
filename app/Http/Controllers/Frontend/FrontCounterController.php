...
class FrontCounterController extends Controller
{
  ...
  /**
    ...
    public function index()
    {
        ...
        return view('tenant.frontend.backend.counters.index');
    }
   ...
   {
       return view('tenant.frontend.backend.counters.create');
   }

   public function edit($id)
   {
       $counter= FrontCounter::find($id);
       return view('tenant.frontend.backend.counters.edit')->with(compact('counter'));
