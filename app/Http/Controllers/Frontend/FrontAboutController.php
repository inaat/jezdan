...
class FrontAboutController extends Controller
{
  ...
  /**
    ...
    public function index()
    {
        ...
        return view('tenant.frontend.backend.about.index');
    }
   ...
   {
       return view('tenant.frontend.backend.about.create');
   }

   public function edit($id)
   {
       $about= FrontAboutUs::find($id);
       return view('tenant.frontend.backend.about.edit')->with(compact('about'));
