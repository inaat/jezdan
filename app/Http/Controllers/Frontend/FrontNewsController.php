...
class FrontNewsController extends Controller
{
     ...
     /**
       ...
       public function index()
       {
           ...
           return view('tenant.frontend.backend.news.index');
       }
   ...
   {
       return view('tenant.frontend.backend.news.create');
   }
   ...
   public function edit($id)
   {
       ...
       return view('tenant.frontend.backend.news.edit')->with(compact('news'));
   }
