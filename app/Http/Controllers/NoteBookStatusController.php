...
class NoteBookStatusController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.note_book.index')->with(compact('campuses'));
    }
  ...
  /**
    ...
    public function create()
    {
        ...
        return view('tenant.note_book.create')->with(compact('campuses'));
    }
    public function noteBookAssignSearch(Request $request)
    {
       ...
       // dd()
        ...
        return view('tenant.note_book.note_book_assign')->with(compact('note_books', 'teachers', 'class_subjects', 'students', 'campuses', 'classes', 'sections', 'campus_id', 'class_id', 'class_section_id', 'date'));
    }
    ...
    public function noteBookEmptyPrintCreate()
    {
        ...
        return view('tenant.note_book.print_create')->with(compact('campuses'));
    }
    ...
    $pdf_name='hrm'.'.pdf';
    $snappy  = \WPDF::loadview('tenant.note_book.print_data', compact('note_books', 'class_subjects', 'sections'));
    $headerHtml = view()->make('common._header')->render();
    $footerHtml = view()->make('common._footer')->render();
    $snappy->setOption('header-html', $headerHtml);
    $snappy->setOption('footer-html', $footerHtml);
