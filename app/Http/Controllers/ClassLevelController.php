...
class ClassLevelController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.admin.global_configuration.class_levels.index');
    }
    ...
    public function create()
    {
        ...
        return view('tenant.admin.global_configuration.class_levels.create');
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.admin.global_configuration.class_levels.edit')
