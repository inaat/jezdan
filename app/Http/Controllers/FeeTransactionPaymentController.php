    ...
    */
    ...
    public function show($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.fee_transaction_payment.show_payments')
    ...
    public function addPayment($transaction_id)
    {
        ...
        if (request()->ajax()) {
            ...
            if ($transaction->payment_status != 'paid') {
                ...
                $view = view('tenant.fee_transaction_payment.payment_row')
    ...
    public function getPayStudentDue($student_id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.fee_transaction_payment.pay_student_due_modal')
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.fee_transaction_payment.edit_payment_row')
    ...
    public function addStudentAdvanceAmountPayment($student_id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.fee_transaction_payment.post_student_advance_amount')
    ...
    public function feeReceipt()
    {
        ...
        return view('tenant.fee_transaction_payment.fee_receipt')->with(compact('campuses'));
    }
    public function getStudentPaymentDetails($student_id, $campus_id)
    {
        ...
        try {
            ...
            $accounts = $this->feeTransactionUtil->accountsDropdown(1, $student_details->campus_id, false, false, true, true);
            // dd($student);
            $output['html_content'] =  view('tenant.fee_transaction_payment.student_details')
            ->with(compact('student_details', 'payment_types', 'payment_line', 'ob_due', 'amount_formatted', 'accounts'))
            ->render();
        } catch (\Exception $e) {
            \Log::emergency("File:" . $e->getFile(). "Line:" . $e->getLine(). "Message:" . $e->getMessage());
