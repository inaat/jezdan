...
class AnnouncementController extends Controller
{
    ...
    public function index() {
        ...
        // return view('tenant.announcement.index', compact('class_section'));
    }
    public function create(){
        $campuses=Campus::forDropdown();
        return response(view('tenant.announcement.create', compact('campuses'))); 
    }
    ...
    public function show() {
        ...
        // return view('tenant.announcement.list',compact('announcement'));
        $offset = 0;
        $limit = 10;
        $sort = 'id';
        $order = 'DESC';
