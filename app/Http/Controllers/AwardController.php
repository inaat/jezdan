...
class AwardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.admin.global_configuration.award.index');
    }
    ...
    public function create()
    {
        ...
        return view('tenant.admin.global_configuration.award.create');
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            $award = Award::find($id);
            return view('tenant.admin.global_configuration.award.edit')
                ->with(compact('award'));
        }
    }
