...
class CityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.admin.global_configuration.cities.index');
    }
    ...
    public function create()
    {
        ...
        return view('tenant.admin.global_configuration.cities.create')->with(compact('countries'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('tenant.admin.global_configuration.cities.edit')->with(compact('countries', 'districts', 'provinces','city'));
