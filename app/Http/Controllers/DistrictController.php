...
class DistrictController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.admin.global_configuration.districts.index');
    }
    /**
    ...
    public function create()
    {
        ...
        return view('tenant.admin.global_configuration.districts.create')->with(compact('countries'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('tenant.admin.global_configuration.districts.edit')->with(compact('countries', 'district', 'provinces'));
    }
