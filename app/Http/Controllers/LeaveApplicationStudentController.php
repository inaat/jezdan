...
if ($user->user_type == 'student' || $user->user_type == 'guardian') {
    ...
    $status ='<a href="#"'.'data-leave_id="' . $row->id .
        ...
        return view('tenant.leave_applications_student.index')->with(compact('campuses'));
    }
    ...
    public function create()
    {
     ...
     if ($user->user_type == 'guardian') {
        ...
        return view('tenant.leave_applications_student.create')->with(compact('campuses','students'));
    }
