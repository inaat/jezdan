...
class CategoryController extends Controller
{
    public function index()
    {
        ...
        return view('tenant.admin.global_configuration.categories.index');
    }
    /**
    ...
    public function create()
    {
        ...
        return view('tenant.admin.global_configuration.categories.create');
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.admin.global_configuration.categories.edit')
