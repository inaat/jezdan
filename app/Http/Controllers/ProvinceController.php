...
class ProvinceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.admin.global_configuration.provinces.index');
    }
    ...
    public function create()
    {
        ...
        return view('tenant.admin.global_configuration.provinces.create')->with(compact('countries'));
    ...
    public function edit($id)
    {
        ...
        return view('tenant.admin.global_configuration.provinces.edit')->with(compact('countries','province'));
