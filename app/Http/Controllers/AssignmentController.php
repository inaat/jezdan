...
class AssignmentController extends Controller
{
    ...
    public function index()
    {
       ...
       //dd($assignments);
        ...
        $campuses=Campus::forDropdown();
         return response(view('tenant.assignment.index', compact('campuses')));
    }
    public function create(){
        $campuses=Campus::forDropdown();
        return response(view('tenant.assignment.create', compact('campuses'))); 
    }
    /**
    ...
    public function viewAssignmentSubmission()
    {
        ...
        return response(view('tenant.assignment.submission', compact('class_section', 'subjects')));
    }
