  ...
  /**
    ...
    */
    ...
    public function create()
    {
        ...
        return view('tenant.certificate.certificate_issue.create')->with(compact('campuses', 'certificate_type'));
    }
    ...
    public function issuePost(Request $request)
    {
        ...
        if ($input['certificate_type_id'] == 1) {
            ...
            return view('tenant.certificate.certificate_issue.create')->with(compact('withdrawal_students', 'campuses', 'roll_no', 'classes', 'certificate_type', 'campus_id', 'class_id', 'certificate_type_id'));
        } else {
            ...
            return view('tenant.certificate.certificate_issue.create')->with(compact('students', 'campuses', 'classes', 'roll_no', 'certificate_type', 'campus_id', 'class_id', 'certificate_type_id'));
        }
