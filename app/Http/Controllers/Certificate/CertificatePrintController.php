...
class CertificatePrintController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        return view('tenant.certificate.print.index')->with(compact('campuses','certificate_type'));
    }
    ...
    private function slcPrint($withdrawal_register, $certificate_issue)
    {
        ...
        $output['html_content'] = view('tenant.certificate.print.slc', compact('withdrawal_register', 'certificate_issue','birth_date'))->render();
