...
class CertificateBulkPrintController extends Controller
{
    ...
    */
    public function create()
    {
        ...
        return view('tenant.certificate.certificate_bulk_print.create')->with(compact('campuses', 'certificate_type'));
    }
    public function store(Request $request)
    {
        ...
        return view('tenant.certificate.certificate_bulk_print.create')->with(compact('campuses', 'certificate_type','certificate_type_id','certificate_issue'));
    }
