...
class WithdrawalRegisterController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        return view('tenant.certificate.withdrawal.index')->with(compact('campuses', 'class_level'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('tenant.certificate.withdrawal.edit')->with(compact('withdrawal_register', 'slc_no'));
    }
    ...
    ->rawColumns(['rownum','remarks','birth_date','action']);
        ...
        // dd($sessions);
        $campuses=Campus::forDropdown();
        return view('tenant.certificate.withdrawal.withdrawal_students')->with(compact('campuses', 'sessions', 'class_level'));
    }
    ...
    private function receiptContent($withdrawal_register, $class_level)
    {
        ...
        $output['html_content'] = view('tenant.certificate.withdrawal.print', compact('withdrawal_register', 'class_level'))->render();
    ...
    public function withdrawalRegisterEdit($id){
        ...
        return view('tenant.certificate.withdrawal.update_modal')->with(compact('withdrawal_register'));
