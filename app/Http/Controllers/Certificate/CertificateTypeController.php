...
class CertificateTypeController extends Controller
{
  ...
  public function index()
  {
      ...
      return view('tenant.certificate.certificate_type.index');
  }
  ...
  public function create()
  {
      ...
      //     abort(403, 'Unauthorized action.');
      // }
      return view('tenant.certificate.certificate_type.create');
  }
  ...
  public function edit($id)
  {
      ...
      if (request()->ajax()) {
          ...
          return view('tenant.certificate.certificate_type.edit')
