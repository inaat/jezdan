...
class DiscountController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.admin.discounts.index');
    }
    /**
    ...
    public function create()
    {
        ...
        return view('tenant.admin.discounts.create')->with(compact('campuses'));;
    }
    ...
    public function edit($id)
    {
        ...
        $campuses=Campus::forDropdown();
        return view('tenant.admin.discounts.edit')->with(compact('discount','campuses'));
