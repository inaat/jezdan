...
if ($row->total_admission_fee<=0) {
    $html.='<li><a class="dropdown-item admission_add_button " href="#" data-href="' . action('StudentController@addAdmissionFee', [$row->id]) . '"><i class="bx bxs-plus-square "></i> ' . __("english.add_admission_fee") . '</a></li>';
      ...
      //  dd($classes);
        return view('tenant.students.index')->with(compact('campuses', 'vehicles','campus_id','class_id','class_section_id','classes','sections'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.students.create')->with(compact('campuses', 'countries', 'sessions', 'admission_no', 'categories', 'districts', 'vehicles'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('tenant.students.edit')->with(compact(
            'student',
            'campuses',
            'countries',
            'sessions',
    ...
    */
    public function addSibling()
    {
        ...
        return view('tenant.students.sibling')->with(compact('campuses', 'classes'));
    }
    ...
    */
    public function addAdmissionFee($id)
    {
        ...
        return view('tenant.students/partials.admission_fee')->with(compact('student', 'fee_heads', 'classes','actual_transcation'));
    }
    ...
    public function studentProfile($id)
    {
        ...
        if ($user->hook_id == $id || $user->user_type =='guardian' || $user->user_type =='admin' || $user->user_type =='other') {
            ...
            if ($user->user_type =='guardian') {
                ...
                if (!empty($child[$id])) {
                    return view('tenant.students.profile')->with(compact('student', 'siblings', 'exam', 'timetables', 'all_subjects'));
                } else {
  ...
  public function getLedger()
  {
      ...
      if (request()->input('action') == 'pdf') {
          $for_pdf = true;
          $html = view('tenant.students.partials.fee_ledger')
      ...
      return view('tenant.students.partials.fee_ledger')
  ...
  public function get_documents()
  {
          ...
          ->addColumn(
             ...
             <ul class="dropdown-menu" style="">';
                  ...
                  if (auth()->user()->can('student_document.download')) {
                      $html .= '<li><a  class="dropdown-item  " href="' . url('tenant/uploads/document/' . $row->filename) .'" download="' . $document_name . '"><i class="fas fa-download" ></i> ' . __("english.download_document") . '</a></li>';
                  }
                  if (isFileImage($document_name)) {
                      $html .= '<li><a href="#" data-href="' . url('tenant/uploads/document/' . $row->filename) .'" class=" dropdown-item  view_uploaded_document"><i class="fas fa-image"></i> ' . __("english.view_document") . '</a></li>';
                  }
    ...
    public function document_create($id)
    {
        ...
        return view('tenant.students.document_create')->with(compact('student_id'));
    }
    ...
    public function bulkEdit(){
        ...
        return view('tenant.students.bulk.edit')->with(compact('campuses'));     
    }
    public function getBulkEdit(Request $request){
       ...
       // dd($students);
        ...
        return view('tenant.students.bulk.edit_students')->with(compact('students','campuses','classes','sections','campus_id','class_id','class_section_id'));
