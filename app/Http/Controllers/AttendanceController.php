...
//         dd($students);
       ...
       if ($permitted_campuses != 'all') {
        ...
        return view('tenant.attendance.index')->with(compact('campuses','status'));
    }
    ...
    {   if (!auth()->user()->can('student_attendance.create')) {
        ...
        $campuses=Campus::forDropdown();
        return view('tenant.attendance.create')->with(compact('campuses'));
    }
    public function attendanceAssignSearch(Request $request)
    {
        ...
        return view('tenant.attendance.attendance_assign')->with(compact('students', 'campuses', 'classes', 'sections', 'campus_id', 'class_id', 'class_section_id', 'date', 'attendance_list'));
    }
    /**
