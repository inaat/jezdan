...
class IndividualFeeCollectionController extends Controller
{
    ...
    */
    ...
    public function create()
    {
        ...
        //dd($sessions);
        return view('tenant.individual-fee-collection.create')->with(compact('campuses', 'students', 'sessions', 'now_month', 'active_session'));
    }
    ...
    public function show($id)
    {
        ...
        try {
            ...
            $output['html_content'] =  view('tenant.individual-fee-collection.fee_payment_row')
            ->with(compact(
                'fee_transaction',
                'campuses',
                'classes',
