...
class DesignationController extends Controller
{
  ...
  public function index()
  {
      ...
      return view('tenant.admin.global_configuration.designation.index');
  }
  ...
  public function create()
  {
      ...
      //     abort(403, 'Unauthorized action.');
      // }
      return view('tenant.admin.global_configuration.designation.create');
  }
  ...
  public function edit($id)
  {
      ...
      if (request()->ajax()) {
          ...
          return view('tenant.admin.global_configuration.designation.edit')
