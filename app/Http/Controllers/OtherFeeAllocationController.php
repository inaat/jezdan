...
class OtherFeeAllocationController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('tenant.other_fee_allocation.create')->with(compact('campuses', 'now_month', 'sessions', 'active_session'));
    }
    public function feesAssignSearch(Request $request)
    {
        ...
        return view('tenant.other_fee_allocation.fees_assign')->with(compact('type','students', 'fee_heads', 'campuses', 'classes', 'sections', 'campus_id', 'class_id', 'class_section_id', 'month_year', 'due_date'));
    }
