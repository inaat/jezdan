...
class CurriculumController extends Controller
{
    ...
    if ($permitted_campuses != 'all') {
      $ClassSubjects->whereIn('subject_teachers.campus_id', $permitted_campuses);
        ...
        return view('tenant.Curriculum.class_wise_subject.index')->with(compact('class_section_id','class_section_detail'));
    }
    ...
    public function create($class_section_id)
    {
        ...
        return view('tenant.Curriculum.class_wise_subject.create')->with(compact('class_section_detail', 'teachers', 'classSubject'));
    }
    /**
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            $teachers=HrmEmployee::teacherDropdown();
            //dd($teachers);
            return view('tenant.Curriculum.class_wise_subject.edit')
