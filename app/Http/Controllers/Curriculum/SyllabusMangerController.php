...
class SyllabusMangerController extends Controller
{
    public function index()
    {
        ...
        return view('tenant.Curriculum.syllabus.index')->with(compact('campuses', 'term'));
    }
/**
    ...
    public function create()
    {
        ...
        $campuses=Campus::forDropdown();
        $term=ExamTerm::forDropdown();
        return view('tenant.Curriculum.syllabus.create')->with(compact('campuses', 'term'));
    }
    /**
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.Curriculum.syllabus.edit')
