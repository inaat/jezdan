...
if (auth()->user()->can('study_period.delete')) {
    $html.='<li><a class="dropdown-item  delete_period_button"data-href="' . action('Curriculum\ClassTimeTablePeriodController@destroy', [$row->id]) . '"><i class="bx bxs-trash "></i> ' . __("english.delete") . '</a></li>';
        ...
        return view('tenant.Curriculum.class_time_table_period.index');
    }
         /**
    ...
    public function create()
    {
        ...
        return view('tenant.Curriculum.class_time_table_period.create')->with(compact('campuses'));
    }
    //   /**
    ...
    public function edit($id)
    {
        ...
        return view('tenant.Curriculum.class_time_table_period.edit')->with(compact('campuses', 'classTimeTablePeriod'));
    }
       /**
