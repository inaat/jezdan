...
class MyLibraryController extends Controller
{
    ...
    */
    ...
    public function index(){
        ...
        return view('tenant.Curriculum.my_library.index')->with(compact('classes'));
    }
    public function getSubjectsByClass($id){
        $classes=Classes::find($id);

        $subjects=ClassSubject::where('class_id',$id)->get();
        return view('tenant.Curriculum.my_library.subjects')->with(compact('subjects','classes'));
    }
    public function getSubjectsChapters($id){
        ...
        return view('tenant.Curriculum.my_library.chapters')->with(compact('chapters','subject'));
    }
    public function getChaptersLessons($id){
       ...
       // dd($lessons);
        return view('tenant.Curriculum.my_library.lesson')->with(compact('chapter','subject','lessons'));
    }
