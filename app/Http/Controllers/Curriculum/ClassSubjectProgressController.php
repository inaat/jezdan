...
class ClassSubjectProgressController extends Controller
{
    ...
    */
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($class_subject_progress)
                ...
                ->editColumn(
                    'status',
                    function ($row) {
                        return (string) view('tenant.Curriculum.progress.session_status', ['status'=>$row->status,'id' => $row->id,'start_date'=>$row->start_date,'complete_date'=>$row->complete_date,'reading_date'=>$row->reading_date]);
                    }
                )
    ...
    public function create($id)
    {
        ...
        return view('tenant.Curriculum.progress.create')->with(compact('campuses', 'class_subject', 'chapters'));
    }
    /**
    ...
    public function show($id)
    {
        ...
        return view('tenant.Curriculum.class_subject_progress.index')->with(compact('class_subject', 'chapters'));
    }
