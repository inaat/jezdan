...
class PaperMakerController extends Controller
{
    public function manualPaperCreate()
    {
        ...
        return view('tenant.Curriculum.paper_maker.manual_paper_create')->with(compact('campuses', 'sessions'));
    }
...
if ($class_subject->subject_input =='eng') {
    $output  = view('tenant.Curriculum.paper_maker.generate_manual_paper', compact(
        'mcq_questions',
    ...
    $output  = view('tenant.Curriculum.paper_maker.urdu_manual_paper', compact(
        'mcq_questions',
        'fill_in_the_blank_questions',
        'true_and_false_questions',
        'words_and_use_questions',
    ...
    $short_questions,$long_questions,$column_matching_questions,$input)
    {
        ...
        $output['html_content'] = view('tenant.Curriculum.paper_maker.urdu_manual_papaer', compact('mcq_questions','fill_in_the_blank_questions','true_and_false_questions',
        'short_questions','long_questions','column_matching_questions','class_subject','input'))->render();
        }else{
            $output['html_content'] = view('tenant.Curriculum.paper_maker.generate_manual_paper', compact('mcq_questions','fill_in_the_blank_questions','true_and_false_questions',
            'short_questions','long_questions','column_matching_questions','class_subject','input'))->render(); 
        }
