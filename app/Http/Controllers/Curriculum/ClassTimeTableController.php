...
class ClassTimeTableController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.Curriculum.class_time_table.index')->with(compact('classes','class_sections','sections','class_time_table_title','campuses','campus_id','class_id','class_section_id','all_subjects','teachers'));
    }
         /**
    ...
    public function create()
    {
        ...
        return view('tenant.Curriculum.class_time_table.create')->with(compact('campuses'));
    }
    //   /**
    ...
    public function edit($id)
    {
        ...
        return view('tenant.Curriculum.class_time_table.edit')->with(compact('campuses','classes','class_sections','classSubject','classTimeTablePeriod','classTimeTable'));
    }
       /**
    ...
    $snappy  = \WPDF::loadview('tenant.school-printing.time_table.print', compact('sections', 'class_time_table_title', 'all_subjects', 'teachers'));
