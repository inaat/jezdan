...
class AssignSubjectTeacherController extends Controller
{
    ...
    {if (!auth()->user()->can('assign_subject.view')) {
        ...
        return view('tenant.Curriculum.assign_section_subject_with_teacher.index')->with(compact('campuses'));
    }
    public function create()
    {
        ...
        return view('tenant.Curriculum.assign_section_subject_with_teacher.create')->with(compact('campuses', 'teachers'));
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            $teachers=HrmEmployee::teacherDropdown();
            //dd($teachers);
            return view('tenant.Curriculum.assign_section_subject_with_teacher.edit')
