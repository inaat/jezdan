...
class ClassSubjectLessonController extends Controller
{
    ...
    public function create($id)
    {
        ...
        return view('tenant.Curriculum.lesson.create')->with(compact('campuses', 'class_subject', 'chapters'));
    }
    /**
    ...
    public function show($id)
    {
        ...
        return view('tenant.Curriculum.lesson.index')->with(compact('class_subject', 'chapters'));
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.Curriculum.lesson.edit')->with(compact('subject_lesson', 'class_subject', 'chapters'));
        }
    }
