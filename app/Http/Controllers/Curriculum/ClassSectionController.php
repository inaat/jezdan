...
class ClassSectionController extends Controller
{
    ...
    public function index($class_id)
    {
        ...
        return view('tenant.Curriculum.class_wise_section.index')->with(compact('class_id'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.admin.class_section.create')->with(compact('campuses','classes','teachers'));
    }
    ...
    public function edit($id)
    {
        ...
        $classes=Classes::forDropdown($system_settings_id);
        $teachers=HrmEmployee::teacherDropdown();
        return view('tenant.admin.class_section.edit')->with(compact('classes','campuses','sections','teachers'));
