...
class ManageSubjectController extends Controller
{
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($chapters)
                ...
                ->editColumn('chapter_name', function ($row) {
                    ...
                    $status = '<div>
             <img src="' . url('tenant/uploads/subjects/' . $image) . '" class="rounded-circle " width="50" height="50" alt="" >
    ...
    public function create($id)
    {
        ...
        return view('tenant.Curriculum.manage_subject.chapter_create')->with(compact('class_subject'));
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.Curriculum.manage_subject.chapter_edit')->with(compact('class_subject', 'chapter'));
        }
    }
...
foreach ($request->file as $key => $file) {
    ...
    public function show($id)
    {
        ...
        return view('tenant.Curriculum.manage_subject.show')->with(compact('class_subject', 'chapters', 'section'));
    ...
    public function getSubjectChaptersQuestions(Request $request)
    {
        ...
        return view('tenant.Curriculum.paper_maker.manual_paper_get_questions')->with(
            compact(
                'campuses',
                'total_mcq',
    ...
    public function getQuestionsAccordingConfig(Request $request)
    {
        ...
        return view('tenant.Curriculum.paper_maker.manual_paper')->with(
            compact(
                'campuses',
                'mcq_questions',
                'overallMark',
