...
class ClassSubjectController extends Controller
{
    ...
    */
    ...
    public function index()
    {
                ...
                ->addColumn(
                    ...
                    function ($row) {
                        ...
                        if (auth()->user()->can('student_document.download')) {
                            $html .= '<li><a  class="dropdown-item  " href="' . url('tenant/uploads/subjects/' . $row->subject_book) .'" download="' . $document_name . '"><i class="fas fa-download" ></i> ' . __("english.download_document") . '</a></li>';
                        }
                        $html .= '</ul></div>';
        ...
        return view('tenant.Curriculum.class_subject.index')->with(compact('campuses'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.Curriculum.class_subject.create')->with(compact('campuses'));
    }
    /**
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            // dd($teachers);
            return view('tenant.Curriculum.class_subject.edit')
