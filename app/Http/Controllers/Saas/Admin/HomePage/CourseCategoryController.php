...
class CourseCategoryController extends Controller
{
  public function index()
  {
    ...
    return view('saas.admin.home-page.course-category-section', $information);
  }
  ...
  public function updateImage(Request $request)
  {
    ...
    if ($request->hasFile('image')) {
      $imgName = UploadFile::update('./assets/saas/admin/img/', $request->file('image'), $data->course_categories_section_image);
