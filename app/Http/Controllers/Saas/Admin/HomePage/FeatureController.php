...
class FeatureController extends Controller
{
  public function index(Request $request)
  {
    ...
    return view('saas.admin.home-page.feature-section.index', $information);
  }
  ...
  public function updateImage(Request $request)
  {
    ...
    if ($request->hasFile('features_section_image')) {
      $imgName = UploadFile::update('./assets/saas/admin/img/', $request->file('features_section_image'), $data->features_section_image);
  ...
  public function store(FeatureRequest $request)
  {
    ...
    if ($validator->fails()) {
     ...
     // store data in db start
      $imageName = UploadFile::store('./assets/saas/admin/img/', $request->file('image'));
  ...
  public function update(Request $request)
  {
    ...
    if ($request->hasFile('image')) {
      $imageName = UploadFile::update('./assets/saas/admin/img/', $request->file('image'), $feature->image);
    }
