...
class VideoController extends Controller
{
  public function index(Request $request)
  {
    ...
    return view('saas.admin.home-page.video-section', $information);
  }
  ...
  public function update(Request $request)
  {
    ...
    if (empty($videoInfo)) {
      $imageName = UploadFile::store('./assets/saas/admin/img/video-images/', $request->file('image'));
      ...
      if ($request->hasFile('image')) {
        $imageName = UploadFile::update('./assets/saas/admin/img/video-images/', $request->file('image'), $videoInfo->image);
      }
