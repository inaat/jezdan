...
class TestimonialController extends Controller
{
  public function index(Request $request)
  {
    ...
    return view('saas.admin.home-page.testimonial-section.index', $information);
  }
  ...
  public function updateImage(Request $request)
  {
    ...
    if ($request->hasFile('image')) {
      $imgName = UploadFile::update('./assets/saas/admin/img/', $request->file('image'), $data->testimonials_section_image);
  ...
  {
    $imageName = UploadFile::store('./assets/saas/admin/img/clients/', $request->file('image'));
  ...
  public function update(UpdateRequest $request)
  {
    ...
    if ($request->hasFile('image')) {
      $imageName = UploadFile::update('./assets/saas/admin/img/clients/', $request->file('image'), $testimonial->image);
    }
