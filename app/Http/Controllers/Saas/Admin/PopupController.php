...
class PopupController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    return view('saas.admin.popup.index', $information);
  }
  ...
  {
    return view('saas.admin.popup.popup-type');
  }
  ...
  public function create($type)
  {
    ...
    return view('saas.admin.popup.create', $information);
  }
  ...
  {
    $imageName = UploadFile::store('./assets/saas/admin/img/popups/', $request->file('image'));
  ...
  public function edit($id)
  {
    ...
    return view('saas.admin.popup.edit', compact('popup'));
  }
  ...
  public function update(UpdateRequest $request, $id)
  {
    ...
    if ($request->hasFile('image')) {
      $imageName = UploadFile::update('./assets/saas/admin/img/popups/', $request->file('image'), $popup->image);
    }
