...
class BasicController extends Controller
{
  public function favicon()
  {
    ...
    return view('saas.admin.basic-settings.favicon', ['data' => $data]);
  }
  ...
  public function updateFavicon(Request $request)
  {
    ...
    if ($request->hasFile('favicon')) {
      $iconName = UploadFile::update('./assets/saas/admin/img/', $request->file('favicon'), $data->favicon);
  ...
  public function logo()
  {
    ...
    return view('saas.admin.basic-settings.logo', ['data' => $data]);
  }
  ...
  public function updateLogo(Request $request)
  {
    ...
    if ($request->hasFile('logo')) {
      $logoName = UploadFile::update('./assets/saas/admin/img/', $request->file('logo'), $data->logo);
  ...
  public function information()
  {
    ...
    return view('saas.admin.basic-settings.information', ['data' => $data]);
  }
  ...
  public function themeAndHome()
  {
    ...
    return view('saas.admin.basic-settings.theme-&-home', ['data' => $data]);
  }
  ...
  public function currency()
  {
    ...
    return view('saas.admin.basic-settings.currency', ['data' => $data]);
  }
  ...
  public function appearance()
  {
    ...
    return view('saas.admin.basic-settings.appearance', ['data' => $data]);
  }
  ...
  public function mailFromAdmin()
  {
    ...
    return view('saas.admin.basic-settings.email.mail-from-admin', ['data' => $data]);
  }
  ...
  public function mailToAdmin()
  {
    ...
    return view('saas.admin.basic-settings.email.mail-to-admin', ['data' => $data]);
  }
  ...
  public function breadcrumb()
  {
    ...
    return view('saas.admin.basic-settings.breadcrumb', ['data' => $data]);
  }
  ...
  public function updateBreadcrumb(Request $request)
  {
    ...
    if ($request->hasFile('breadcrumb')) {
      $breadcrumbName = UploadFile::update('./assets/saas/admin/img/', $request->file('breadcrumb'), $data->breadcrumb);
  ...
  public function plugins()
  {
    ...
    return view('saas.admin.basic-settings.plugins', ['data' => $data]);
  }
  ...
  public function maintenance()
  {
    ...
    return view('saas.admin.basic-settings.maintenance', ['data' => $data]);
  }
  ...
  public function updateMaintenance(Request $request)
  {
    ...
    if ($request->hasFile('maintenance_img')) {
      $imageName = UploadFile::update('./assets/saas/admin/img/', $request->file('maintenance_img'), $data->maintenance_img);
    }
  ...
  public function footerLogo()
  {
    ...
    return view('saas.admin.basic-settings.footer-logo', ['data' => $data]);
  }
  ...
  public function updateFooterLogo(Request $request)
  {
    ...
    if ($request->hasFile('footer_logo')) {
      $logoName = UploadFile::update('./assets/saas/admin/img/', $request->file('footer_logo'), $data->footer_logo);
  ...
  public function advertiseSettings()
  {
    ...
    return view('saas.admin.advertisement.settings', ['data' => $data]);
  }
