...
class BlogController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    return view('saas.admin.journal.blog.index', $information);
  }
  ...
  public function create()
  {
    ...
    return view('saas.admin.journal.blog.create', $information);
  }
  ...
  public function store(StoreRequest $request)
  {
    ...
    $imgName = UploadFile::store('./assets/saas/admin/img/blogs/', $request->file('image'));
  ...
  public function edit($id)
  {
    ...
    return view('saas.admin.journal.blog.edit', $information);
  }
  ...
  public function update(UpdateRequest $request, $id)
  {
    ...
    if ($request->hasFile('image')) {
      $imgName = UploadFile::update('./assets/saas/admin/img/blogs/', $request->file('image'), $blog->image);
    }
