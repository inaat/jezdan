                ...
                function ($row) {
                 ...
                 <ul class="dropdown-menu" style="">';
                    if (auth()->user()->can("leave_applications_for_student.view") && !empty($row->document)) {
                        ...
                        $html .= '<li><a  class="dropdown-item  " href="' . url('tenant/uploads/documents/' . $row->document) .'" download="' . $document_name . '"><i class="fas fa-download" aria-hidden="true"></i>' . __("english.download_document") . '</a></li>';
                        if (isFileImage($document_name)) {
                            $html .= '<li><a href="#" data-href="' . url('tenant/uploads/documents/' . $row->document) .'" class=" dropdown-item  view_uploaded_document"><i class="fas fa-image" aria-hidden="true"></i>' . __("english.view_document") . '</a></li>';
                        }
                    }
                    $html .= '</ul></div>';
...
if ($user->user_type == 'staff' || $user->user_type == 'teacher') {
    ...
    $status ='<a href="#"'.'data-leave_id="' . $row->id .
        ...
        return view('tenant.leave_applications_employee.index')->with(compact('campuses'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.leave_applications_employee.create')->with(compact('campuses', 'employees'));
    }
