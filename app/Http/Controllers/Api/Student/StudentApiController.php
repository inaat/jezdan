...
class StudentApiController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt(['email' => $request->email, 'password' => $request->password])) {
            ...
            unset($user->student);
            $image = file_exists($user->student->student_image) ? url('tenant/uploads/student_image/'.$user->student->student_image) : url('tenant/uploads/student_image/default.png');
            $user = [
              "id" => $user->student->id,
        ...
        try {
          ...
          //dd($subjects);
            ...
            foreach ($subjects as $key => $subject) {
                $image = file_exists($subject->subject_icon) ? url('tenant/uploads/subjects/'.$subject->subject_icon) : url('tenant/uploads/subjects/default.svg');
