...
class TeacherApiController extends Controller
{
    ...
    public function subjects(Request $request)
    {
        ...
        try {
            ...
            foreach ($assign as $key => $value) {
                $image = file_exists( $value->class_subject->subject_icon) ? url('tenant/uploads/subjects/' . $value->class_subject->subject_icon) : url('tenant/uploads/subjects/default.svg');
    ...
    public function getStudentList(Request $request)
    {
        ...
        try {
            ...
            foreach ($students as $key => $student) {
                ...
                $image = file_exists($student->student_image) ? url('tenant/uploads/student_image/' . $student->student_image) : url('tenant/uploads/student_image/default.png');
    ...
    public function getStudentDetails(Request $request)
    {
        ...
        try {
            ...
            $image = file_exists(public_path('uploads/employee_image/default.jpg')) ? url('tenant/uploads/employee_image/default.jpg') : url('tenant/uploads/employee_image/default.jpg');
                ...
                $exam_data[] = array(
                    ...
                    'subject' => array(
                        ...
                        'bg_color' => $data->subject->bg_color,
                          'image' => file_exists($data->subject->subject_icon) ? url('tenant/uploads/subjects/'.$data->subject->subject_icon) : url('tenant/uploads/subjects/default.svg'),
