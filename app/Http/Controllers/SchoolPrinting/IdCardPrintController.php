...
class IdCardPrintController extends Controller
{
    ...
    public function createClassWiseIdPrint()
    {
        ...
        return view('tenant.school-printing.id-card.create')->with(compact('campuses'));
    }
    public function classWiseIdPrintPost(Request $request)
    {
        ...
        return view('tenant.school-printing.id-card.class-id-post')->with(compact('design_type', 'students', 'fee_heads', 'campuses', 'classes', 'sections', 'campus_id', 'class_id', 'class_section_id'));
    }
    ...
    public function createEmployeeIdPrint()
    {
        ...
        return view('tenant.school-printing.employee-id-card.create')->with(compact('campuses', 'designations'));
    }
    public function employeeIdPrintPost(Request $request)
    {
        ...
        return view('tenant.school-printing.employee-id-card.employee-id-post')->with(compact('employees', 'campuses', 'campus_id', 'designations', 'designation_id'));
    }
