...
if (auth()->user()->can('shift.update')) {
    ...
    return '';
        ...
        return view('tenant.hrm.shift.index');
    ...
    public function create()
    {
        ...
        return view('tenant.hrm.shift.create')->with(compact('days'));;
    }
    ...
    {
        return view('tenant.essentials::show');
    }
    ...
    public function edit($id)
    {
        ...
        return view('tenant.hrm.shift.create')->with(compact('shift', 'days'));
    }
    ...
    public function getAssignUsers($shift_id)
    {
        ...
        return view('tenant.hrm.shift.add_shift_employees')
