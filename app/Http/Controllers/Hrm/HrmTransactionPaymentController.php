...
class HrmTransactionPaymentController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if (request()->ajax()) {
           ...
           // dd($transaction);
            ...
            return view('tenant.hrm.hrm_transaction_payment.show_payments')
    ...
    public function addPayment($transaction_id)
    {
        ...
        if (request()->ajax()) {
            ...
            if ($transaction->payment_status != 'paid') {
                ...
                $view = view('tenant.hrm.hrm_transaction_payment.payment_row')
    ...
    public function getPayEmployeeDue($employee_id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.hrm.hrm_transaction_payment.pay_employee_due_modal')
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.hrm.hrm_transaction_payment.edit_payment_row')
...
/**
    ...
    public function addEmployeeAdvanceAmountPayment($employee_id){
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.hrm.hrm_transaction_payment.post_employee_advance_amount')
