...
class HrmAttendanceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.hrm.attendance.index')->with(compact('campuses', 'status'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.hrm.attendance.create')->with(compact('campuses'));
    }
    ...
    public function attendanceAssignSearch(Request $request)
    {
        ...
        return view('tenant.hrm.attendance.attendance_assign')->with(compact('employees', 'campuses', 'campus_id', 'date', 'attendance_list'));
