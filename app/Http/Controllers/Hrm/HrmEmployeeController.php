...
class HrmEmployeeController extends Controller
{
    ...
    */
    ...
    //     dd(2);
         ...
         if (request()->ajax()) {
             ...
             ->addColumn(
                ...
                ->editColumn('employee_name', function ($row) {
                    $image = file_exists($row->employee_image) ? $row->employee_image : 'tenant/uploads/employee_image/default.jpg';
         ...
         return view('tenant.hrm.employee.index')->with(compact('campuses'));
     }
     ...
     public function create()
     {
         ...
         return view('tenant.hrm.employee.create')->with(compact('roles', 'campuses', 'countries', 'admission_no', 'departments', 'designations', 'educations'));
     }
     /**
     ...
     public function store(Request $request)
     {
       ...
       */
       public function edit($id)
       {
           ...
           return view('tenant.hrm.employee.edit')->with(compact('roles', 'campuses', 'employee', 'bank_details', 'countries', 'departments', 'designations', 'educations', 'districts', 'provinces', 'cities', 'regions'));
       }
  ...
  public function employeeProfile($id)
  {
      ...
      if ($user->hook_id == $id || $user->user_type =='admin' || $user->user_type =='other') {
          ...
          return view('tenant.hrm.employee.profile')->with(compact('employee', 'bank_details', 'employee_document'));
      } else {
  ...
  public function get_documents()
  {
          ...
          ->addColumn(
             ...
             <ul class="dropdown-menu" style="">';
                  ...
                  if (auth()->user()->can('employee_document.download')) {
                      $html .= '<li><a  class="dropdown-item  " href="' . url('tenant/uploads/document/' . $row->filename) .'" download="' . $document_name . '"><i class="fas fa-download" aria-hidden="true"></i> ' . __("english.download_document") . '</a></li>';
                  }
                  if (isFileImage($document_name)) {
                      $html .= '<li><a href="#" data-href="' . url('tenant/uploads/document/' . $row->filename) .'" class=" dropdown-item  view_uploaded_document"><i class="fas fa-image" aria-hidden="true"></i> ' . __("english.view_document") . '</a></li>';
                  }
    ...
    public function document_create($id)
    {
        ...
        return view('tenant.hrm.employee.document_create')->with(compact('employee_id'));
    }
   ...
   */
    public function getLedger()
    {
        ...
        if (request()->input('action') == 'pdf') {
            $for_pdf = true;
            $html = view('tenant.hrm.employee.partials.pay_ledger')
        ...
        return view('tenant.hrm.employee.partials.pay_ledger')
