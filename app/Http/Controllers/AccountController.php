...
class AccountController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('tenant.account.show')
    ...
    public function getFundTransfer($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.account.transfer')
    ...
    public function getDeposit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.account.deposit')
    ...
    public function cashFlow()
    {
        ...
        return view('tenant.account.cash_flow')
    ...
    public function getDebit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.account.debit')
                ->with(compact('account', 'account', 'from_accounts'));
        }
    }
...
/**
    ...
    public function editAccountTransaction($id)
    {
        ...
        return view('tenant.account.edit_account_transaction')
    ...
    public function getAccountLedger($id)
    {
        ...
        return view('tenant.account.account_ledger')
