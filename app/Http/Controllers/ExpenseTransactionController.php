    ...
    */
    ...
    public function index()
    {
       ...
       if ($permitted_campuses != 'all') {
           $transactions->whereIn('expense_transactions.campus_id', $permitted_campuses);
            ...
            ->editColumn(
                ...
                function ($row) {
                    ...
                    return (string) view('tenant.expense.partials.payment_status', ['payment_status' => $payment_status, 'id' => $row->id]);
                }
            )
        ...
        return view('tenant.expense.index')->with(compact('campuses', 'vehicles', 'expense_categories'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.expense.create')->with(compact('campuses', 'vehicles', 'expense_categories', 'employees', 'payment_types', 'accounts', 'payment_line'));
    }
