...
class ExpenseTransactionPaymentController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if (request()->ajax()) {
           ...
           // dd($transaction);
            ...
            return view('tenant.expense_transaction_payment.show_payments')
    ...
    public function addPayment($transaction_id)
    {
        ...
        if (request()->ajax()) {
            ...
            if ($transaction->payment_status != 'paid') {
                ...
                $view = view('tenant.expense_transaction_payment.payment_row')
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('tenant.expense_transaction_payment.edit_payment_row')
