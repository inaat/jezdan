...
class RegionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.admin.global_configuration.regions.index');
    }
    /**
    ...
    public function create()
    {
        ...
        return view('tenant.admin.global_configuration.regions.create')->with(compact('countries'));    }
    ...
    public function edit($id)
    {
        if (!auth()->user()->can('region.update')) {
            ...
            return view('tenant.admin.global_configuration.regions.edit')->with(compact('countries', 'districts', 'provinces','cities','region'));
    }
