...
<head>
    ...
    <!--plugins-->
    <link href="{{url('tenant/assets/plugins/simplebar/css/simplebar.css')}}" rel="stylesheet" />
    <link href="{{ url('tenant/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.css')}}" rel="stylesheet" />
    <link href="{{ url('tenant/assets/plugins/metismenu/css/metisMenu.min.css')}}" rel="stylesheet" />
    <!-- Bootstrap CSS -->
    ...
    <link href="{{ url('tenant/assets/css/app.cs')}}s" rel="stylesheet">
...
<body>
                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="mb-4 text-center">
                            <img src="{{ url('tenant/assets/images/logo-img.png')}}" width="180" alt="" style="z-index: 9999; "/>
                        </div>
                        <div class="card">
                            <div class="card-body">
    ...
    <!--end wrapper-->
    <!-- Bootstrap JS -->
    <script src="{{ url('tenant/assets/js/bootstrap.bundle.min.js')}}"></script>
    <!--plugins-->
    <script src="{{ url('tenant/assets/js/jquery.min.js')}}"></script>
    <script src="{{ url('tenant/assets/plugins/simplebar/js/simplebar.min.js')}}"></script>
    <script src="{{ url('tenant/assets/plugins/metismenu/js/metisMenu.min.js')}}"></script>
    <script src="{{ url('tenant/assets/plugins/perfect-scrollbar/js/perfect-scrollbar.js')}}"></script>
