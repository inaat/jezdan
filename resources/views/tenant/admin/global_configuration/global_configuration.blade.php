                      ...
                      <div class="card-body">
                          ...
                          <div class="tab-content py-">
                              <div class="tab-pane fade show active" id="global_config" role="tabpanel">
                                  @include('tenant.admin.global_configuration.partials.general_settings')
                              </div>
                              <div class="tab-pane fade" id="sms_settings" role="tabpanel">
                                  @include('tenant.admin.global_configuration.partials.sms_settings')

                              </div>
                              <div class="tab-pane fade" id="prefixes_setting" role="tabpanel">
                                  @include('tenant.admin.global_configuration.partials.prefixes')
                              </div>
                              <div class="tab-pane fade" id="system_settings" role="tabpanel">
                                  @include('tenant.admin.global_configuration.partials.system_settings')
                              </div>

                              <div class="tab-pane fade" id="email_settings" role="tabpanel">
                                  @include('tenant.admin.global_configuration.partials.email_settings')
                              </div>
                          </div>
                      </div>
                  </div>
