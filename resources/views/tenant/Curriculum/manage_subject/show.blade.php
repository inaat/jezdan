  ...
  @section('wrapper')
                          ...
                          <div class="tab-content py-">
                              @can('chapter.view')
                                  <div class="tab-pane fade show active" id="chapter" role="tabpanel">
                                      @include('tenant.Curriculum.manage_subject.partials.chapter_index')

                                  </div>
                              @endcan
                              @can('lesson.view')
                                  <div class="tab-pane fade show" id="lesson" role="tabpanel">
                                      @include('tenant.Curriculum.lesson.partials.lesson')
                                  </div>
                              @endcan
                              @can('lesson_progress.view')
                                  <div class="tab-pane fade show" id="progress" role="tabpanel">
                                      @include('tenant.Curriculum.progress.partials.progress')
                                  </div>
                              @endcan
                              @can('question_bank.view')
                                  <div class="tab-pane fade show" id="question_bank" role="tabpanel">
                                      @include('tenant.Curriculum.question_bank.partials.question')
      ...
      @endsection
      @section('script')
          <script src="{{url('tenant/js/school.js') }}"></script>

          <script src="{{url('tenant/js/questions.js') }}"></script>
