                            ...
                            <div class="card  box"  style="background: #EBA9A5; width:250px; height:250px;border-radius:50%; margin:0 auto;" >
                                <div class="card-body d-flex align-items-center justify-content-center">
                                     ...
                                     <h3 class="card-title text-center text-white">
                                        ...
                                        <img class="css-pxgg1r box d-flex align-items-center justify-content-center"  style="background: #EBA9A5; margin:0 auto;" src="{{ url('tenant/uploads/subjects/' . $sub->subject_icon)}}" alt="">
                                        <br>
                                        {{ $sub->name}}</h3>
