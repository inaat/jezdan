                ...
                <div class="col-md-9 ">
                    ...
                    <div class="col-lg-3 col-md-3 col-xs-6 ">
                         <a class="w-24 h-24 xl:w-32 xl:h-32 flex items-center justify-center " href="">
                                    <img class="css-pxgg1r box d-flex align-items-center justify-content-center"  style="background: #EBA9A5; margin:0 auto;" src="{{ url('tenant/uploads/subjects/' . $chap->chapter_icon)}}" alt="Maths ">
