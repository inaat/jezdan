...
@section('title', __('english.employees'))
 @section('wrapper')
     ...
     @include('tenant.hrm.employee.partials.update_employee_status_modal')
     @include('tenant.hrm.employee.partials.employee_resign_modal')

 @endsection

 @section('javascript')
 <script src="{{ url('tenant/js/hrm.js') }}"></script>
