                 ...
                 @if($pic->type==1)
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 image">
                        <div class="img-wrapper">
                            <a href="{{url('tenant/uploads/front_image/'.$pic->image)}}"><img src="{{url('tenant/uploads/front_image/'.$pic->image)}}" class="img-responsive"></a>
                   ...
                   @else
                    ...
                    <a data-fancybox="video-gallery" href="{{ $pic->video_url }}">
                        <div class="video-wrapper">
                            <img src="{{url('tenant/uploads/front_image/'.$pic->image)}}"  class="img-responsive">
