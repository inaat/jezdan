                                                    ...
                                                    <div class="col-sm-12 caseletter">
                                                        <div class="table" style="padding-top: 15px;">
                                                            <table border="1" width="100%">
                                                                <tbody>
                                                                    <tr>
                                                                        <td><a href="{{ url('tenant/uploads/front_image/' . $pic->image) }}"
                                                                                target="_blank">{{ $data->title }}<img
                                                                                    style="width: 15px;margin-left: 3px;"
                                                                                    src="{{ url('tenant/uploads/front_image/pdficon.png') }}"></a>
                                                                        </td>
                                                                        <td style="text-align:center !important;"><a
                                                                                href="{{ url('tenant/uploads/front_image/' . $pic->image) }}"
                ...
                <div class="row" id="gallery">
                                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 image">
                                                    <div class="img-wrapper">
                                                        <a href="{{ url('tenant/uploads/front_image/' . $pic->image) }}"><img
                                                                src="{{ url('tenant/uploads/front_image/' . $pic->image) }}"
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 image">
                                                    <a data-fancybox="video-gallery" href="{{ $pic->video_url }}">
                                                        <div class="video-wrapper">
                                                            <img src="{{ url('tenant/uploads/front_image/' . $pic->image) }}"
