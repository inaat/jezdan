                        ...
                        <thead class="table-light" width="100%">
                          ...
                          <tbody>
					       @if(!empty($getJson))
                            ...
                            @if($row['type'] ==3)
							<td><img class="img-border" src="{{ url('tenant/uploads/front_image/pdficon.png') }}" width="50" height="50"/></td>
                           @else
							<td><img class="img-border" src="{{url('tenant/uploads/front_image/'.$row['image']) }}" width="50" height="50"/></td>
