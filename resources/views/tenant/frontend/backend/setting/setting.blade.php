             ...
             <div class="row">
                 ...
                 <div class="clearfix"></div>
                  ...
                  <div class="col-md-4 p-3">
                     ...
                     <div class="col-sm-8">
                         ...
                         <img src="{{'tenant/uploads/front_image/'.$front_settings->admission_banner}}" class="logo_admission_banner card-img-top" alt="...">
                 ...
                 <div class="row p-3">
                     ...
                     <div class="col-sm-4">
                         ...
                         <img src="{{'tenant/uploads/front_image/'.$front_settings->logo_image }}" class="logo_image card-img-top" alt="...">
                     ...
                     <div class="col-sm-4">
                         ...
                         <img src="{{'tenant/uploads/front_image/'.$front_settings->page_banner }}" class="page_banner card-img-top" alt="...">
