...
@section('wrapper')
@section("style")
<link href="{{url('tenant/js/calender/zabuto_calendar.min.css')}}" rel="stylesheet" />
<style>
    .holiday {
                                ...
                                <div class="row row-cols-12 row-cols-md-1 row-cols-lg-12 row-cols-xl-12">
                                    ...
                                    <div class="tab-content py-">
                                        <div class="tab-pane fade show active" id="profile" role="tabpanel">
                                            @include('tenant.students.partials.profile_details')
                                        </div>
                                        <div class="tab-pane fade show" id="exam" role="tabpanel">
                                            @include('tenant.students.partials.exam_details')
                                        </div>
                                        <div class="tab-pane fade show" id="time_table" role="tabpanel">
                                            @include('tenant.students.partials.class_time_table')
                                        </div>
                                        ...
                                        <div class="tab-pane fade show " id="documents" role="tabpanel">
                                            @include('tenant.students.partials.documents')
                                        </div>
                                        @endcan
                                        @can('students_assessment.view')

                                        <div class="tab-pane fade show " id="assessments" role="tabpanel">
                                            @include('tenant.students.partials.assessment')
                                        </div>
                                        @endcan
...
@section('javascript')
<script src="{{url('tenant/js/calender/zabuto_calendar.min.js') }}"></script>
    <script src="{{url('tenant/js/document.js') }}"></script>
