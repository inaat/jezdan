                    ...
                    <div class="col-md-2">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <img src="{{ url('tenant/uploads/student_image/default.png') }}" class="student_image card-img-top" width="192px" height="192px" alt="...">
...
@section('javascript')
<script src="{{url('tenant/js/lib/inputmask.bundle.js') }}"></script>
<script src="{{url('tenant/js/student.js') }}"></script>
