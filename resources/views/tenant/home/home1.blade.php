 @extends("tenant.admin_layouts.app")
 @section('title', __('english.dashboard'))
 @section('wrapper')
 @section("style")
 <link href="{{url('tenant/assets/plugins/highcharts/css/highcharts.css')}}" rel="stylesheet" />
 <link href="{{url('tenant/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css') }}" rel="stylesheet" />
 @endsection
 ...
 <script src="{{url('tenant/assets/plugins/highcharts/js/highcharts.js') }}"></script>
 <script src="{{url('tenant/assets/plugins/highcharts/js/exporting.js') }}"></script>
 <script src="{{url('tenant/assets/plugins/highcharts/js/variable-pie.js') }}"></script>
 <script src="{{url('tenant/assets/plugins/highcharts/js/export-data.js') }}"></script>
 <script src="{{url('tenant/assets/plugins/highcharts/js/accessibility.js') }}"></script>
 <script src="{{url('tenant/assets/plugins/apexcharts-bundle/js/apexcharts.min.js') }}"></script>
 <script src="{{ url('tenant/js/home.js') }}"></script>
