<div class="main-header">
  ...
  <div class="logo-header" data-background-color="{{ $settings->admin_theme_version == 'light' ? 'white' : 'dark2' }}">
    @if (!empty($websiteInfo->logo))
      <a href="{{ route('index') }}" class="logo" target="_blank">
        <img src="{{ asset('assets/saas/admin/img/' . $websiteInfo->logo) }}" alt="logo" class="navbar-brand" width="120">
      </a>
    @endif
  ...
  <!-- Navbar Header Start -->
  <nav class="navbar navbar-header navbar-expand-lg" d data-background-color="{{ $settings->admin_theme_version == 'light' ? 'white2' : 'dark' }}">
  ...
  @if (Auth::guard('admin')->user()->image != null)
          ...
          <ul class="dropdown-menu dropdown-user animated fadeIn">
            <div class="scroll-wrapper dropdown-user-scroll scrollbar-outer" style="position: relative;"><div class="dropdown-user-scroll scrollbar-outer scroll-content" style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 202px;">
              <li>
                <div class="user-box">
                  <div class="avatar-lg">
   @if (Auth::guard('admin')->user()->image != null)
