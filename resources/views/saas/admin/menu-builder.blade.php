...
@section('script')
  <script type="text/javascript" src="{{ asset('assets/saas/admin/js/jquery-menu-editor.min.js') }}"></script>
  ...
  <script type="text/javascript" src="{{ asset('assets/saas//admin/js/menu-builder.js') }}"></script>
@endsection
