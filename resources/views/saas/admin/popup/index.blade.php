                    ...
                    <tbody>
                      @foreach ($popups as $popup)
                        <tr>
                          ...
                          <td>
                            <img src="{{ asset('assets/saas/admin/img/popups/' . $popup->image) }}" alt="popup image" width="55">
                          </td>
                          <td>{{ convertUtf8($popup->name) }}</td>
                          <td>
                            <img src="{{ asset('assets/saas/admin/img/popup-samples/' . $popup->type . '.jpg') }}" alt="popup type image" class="pt-4" width="55">
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1" href="{{ route('admin.announcement_popups.edit_popup', ['id' => $popup->id]) }}">
