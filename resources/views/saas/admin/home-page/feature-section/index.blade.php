...
@section('content')
                        ...
                        <tr>
                          <td>
                            ...
                            <td>
                                ...
                                <img src="{{ asset('assets/saas/admin/img/'.$feature->image) }}" width="50" alt="...">
                                @else
                                <img src="{{ asset('assets/saas/admin/img/noimage.jpg') }}" width="50" alt="...">
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1 editBtn" href="#" data-toggle="modal" data-target="#editModal" data-id="{{ $feature->id }}" data-image="{{ $feature->image }}" data-title="{{ $feature->title }}" data-text="{{ $feature->text }}" data-serial_number="{{ $feature->serial_number }}">
  ...
  {{-- create modal --}}
  @include('saas.admin.home-page.feature-section.create')

  {{-- edit modal --}}
  @include('saas.admin.home-page.feature-section.edit')
@endsection
