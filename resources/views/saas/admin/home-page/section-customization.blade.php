            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                  <div class="form-group">
                    ...
                    <div class="selectgroup w-100">
                      <label class="selectgroup-item">
                        <input type="radio" name="partners_section_status" value="1" class="selectgroup-input" {{ $sectionInfo->partners_section_status == 1 ? 'checked' : '' }}>
                        <span class="selectgroup-button">{{ __('Enable') }}</span>
                      </label>

                      <label class="selectgroup-item">
                        <input type="radio" name="partners_section_status" value="0" class="selectgroup-input" {{ $sectionInfo->partners_section_status == 0 ? 'checked' : '' }}>
                        <span class="selectgroup-button">{{ __('Disable') }}</span>
                      </label>
                    </div>
                    @error('partners_section_status')
                ...
                <div class="form-group">
                  ...
                  <div class="selectgroup w-100">
                    <label class="selectgroup-item">
                      <input type="radio" name="work_process_status" value="1" class="selectgroup-input" {{ $sectionInfo->work_process_status == 1 ? 'checked' : '' }}>
                      <span class="selectgroup-button">{{ __('Enable') }}</span>
                    </label>

                    <label class="selectgroup-item">
                      <input type="radio" name="work_process_status" value="0" class="selectgroup-input" {{ $sectionInfo->work_process_status == 0 ? 'checked' : '' }}>
                      <span class="selectgroup-button">{{ __('Disable') }}</span>
                    </label>
                  </div>
                  @error('work_process_status')
                    <p class="mb-0 text-danger">{{ $message }}</p>
                  @enderror
                </div>
