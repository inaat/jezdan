              ...
              <form id="actionForm" action="{{ route('admin.home_page.update_action_section', ['language' => request()->input('language')]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    @if (!empty($data->background_image))
                      <img src="{{ asset('assets/saas/admin/img/action-section/' . $data->background_image) }}" alt="background image" class="uploaded-background-img">
                    @else
                ...
                @if ($themeInfo->theme_version == 2)
                  <div class="form-group">
                    ...
                    <div class="thumb-preview">
                      @if (!empty($data->image))
                        <img src="{{ asset('assets/saas/admin/img/action-section/' . $data->image) }}" alt="image" class="uploaded-img">
                      @else
