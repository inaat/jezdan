                  ...
                  <div class="row mt-2 justify-content-center">
                    <div class="col-md-3">
                      <label class="imagecheck">
                        ...
                        <figure class="imagecheck-figure">
                          <img src="{{ asset('assets/saas/admin/img/themes/1.png') }}" alt="theme 1" class="imagecheck-image">
                        </figure>
                      </label>
                    </div>
                    ...
                    <div class="col-md-3">
                      <label class="imagecheck">
                        ...
                        <figure class="imagecheck-figure">
                          <img src="{{ asset('assets/saas/admin/img/themes/2.png') }}" alt="theme 2" class="imagecheck-image">
                        </figure>
                      </label>
                    </div>
                    ...
                    <div class="col-md-3">
                      <label class="imagecheck">
                        ...
                        <figure class="imagecheck-figure">
                          <img src="{{ asset('assets/saas/admin/img/themes/3.png') }}" alt="theme 3" class="imagecheck-image">
                        </figure>
                      </label>
                    </div>
